...
@section('title', ($category->seo_title ?: $category->name) . ' - ' . ($globalSettings->site_name ?? 'Website'))

@section('meta')
    <meta name="description" content="{{ $category->seo_description ?: $category->description ?: 'Danh mục ' . $category->name }}">
    <meta property="og:title" content="{{ $category->seo_title ?: $category->name }}">
    <meta property="og:description" content="{{ $category->seo_description ?: $category->description ?: 'Danh mục ' . $category->name }}">
    @if($category->og_image)
        <meta property="og:image" content="{{ Storage::url($category->og_image) }}">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        @else
            ...
            <div class="text-center py-12">
                ...
                <h3 class="text-lg font-medium text-gray-900 mb-2">Chưa có bài viết</h3>
                <p class="text-gray-600 mb-4">Danh mục này chưa có bài viết nào</p>
